---
name: ecommerce-plan
description: Complete eCommerce implementation plan for Baagicha — 5-phase roadmap with backend (Laravel) + frontend (React Native), database schema, API endpoints, and category taxonomy. Use when working on Shop module, cart, checkout, payments, or product catalog.
---
